 ...
 */
@UnstableApi
public final class MikuDirectAudioSink implements AudioSink {
  ...
  public interface AudioTrackBufferSizeProvider extends DefaultAudioSink.AudioTrackBufferSizeProvider {}

  /**
   * Provides the {@link AudioOffloadSupport} to convey the level of offload support the sink can
   * provide.
   */
  public interface AudioOffloadSupportProvider extends DefaultAudioSink.AudioOffloadSupportProvider {}

  /** A builder to create {@link MikuDirectAudioSink} instances. */
  public static final class Builder {
    ...
    public Builder() {
      ...
      audioTrackBufferSizeProvider = androidx.media3.exoplayer.audio.DefaultAudioSink.AudioTrackBufferSizeProvider.DEFAULT;
    }
    ...
    public Builder setAudioTrackBufferSizeProvider(
        androidx.media3.exoplayer.audio.DefaultAudioSink.AudioTrackBufferSizeProvider audioTrackBufferSizeProvider) {
     ...
     *
     * <p>If this setter is not called, then the {@link MikuDirectAudioSink} uses an instance of {@link
     * DefaultAudioOffloadSupportProvider}.
     */
    public Builder setAudioOffloadSupportProvider(
        androidx.media3.exoplayer.audio.DefaultAudioSink.AudioOffloadSupportProvider audioOffloadSupportProvider) {
    ...
    /** Builds the {@link MikuDirectAudioSink}. Must only be called once per Builder instance. */
    public MikuDirectAudioSink build() {
      ...
      return new MikuDirectAudioSink(this);
    }
  }
  ...
  private static final String TAG = "MikuDirectAudioSink";
  ...
  private MikuDirectAudioSink(Builder builder) {
  ...
  private final class StreamEventCallbackV29 {
    ...
    public StreamEventCallbackV29() {
      ...
      // would cause a NoClassDefFoundError warning on load of MikuDirectAudioSink for SDK < 29.
